...
int main(int argc, char *argv[])
{
	...
	for(i=0;i<3;i++){
		...
		fp = FileOpen(outfile, "w");
		fprintf(fp, "4-Clique(true),4-Clique(emp1),4-Clique(emp2),4-Clique(emp3),4-Clique(clip1),4-Clique(clip2),4-Clique(clip3),4-Clique(rel-err(emp1)),4-Clique(rel-error(emp2)), 4-Clique(rel-err(emp3)),4-Clique(rel-error(clip1)). 4-Clique(rel-err(clip2)),4-Clique(rel-error(clip3))\n");
		fclose(fp);
	}
	...
	fprintf(fp, "4-Cliques,%e,%e,%e,%e,%e,%e\n", cliq_4_num_avg_re1, cliq_4_num_avg_re2, cliq_4_num_avg_re3, clip_cliq_num_avg_re1, cliq_4_num_avg_re2, cliq_4_num_avg_re3);
	fclose(fp);
